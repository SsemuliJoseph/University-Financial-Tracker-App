                    ...
                    <?php else: ?>
                        <?php foreach ($transactions as $t): ?>
                            <tr class="transaction-row">
                                ...
                                <td data-label="Date"><?= htmlspecialchars($t['transaction_date']) ?></td>
                                <td class="desc-cell fw-medium" data-label="Description">
                                ...
                                <td class="text-end fw-bold <?= $t['type'] === 'income' ? 'text-success' : 'text-danger' ?>" data-label="Amount">
