    ...
    <div class="col-md-6 col-lg-3">
        <div class="card border-0 shadow-sm hover-lift h-100 position-relative overflow-hidden">
            <div class="card-body d-flex flex-column justify-content-center">
                ...
                <h3 class="fw-bold mb-0 text-primary">UGX <span class="count-up" data-value="<?= (float)$balance ?>">0</span></h3>
            </div>
    ...
    <div class="col-md-6 col-lg-3">
        <div class="card border-0 shadow-sm hover-lift h-100 position-relative overflow-hidden">
            <div class="card-body d-flex flex-column justify-content-center">
                ...
                <h3 class="fw-bold mb-0 text-success">UGX <span class="count-up" data-value="<?= (float)$monthlyIncome ?>">0</span></h3>
            </div>
    ...
    <div class="col-md-6 col-lg-3">
        <div class="card border-0 shadow-sm hover-lift h-100 position-relative overflow-hidden">
            <div class="card-body d-flex flex-column justify-content-center">
                ...
                <h3 class="fw-bold mb-0 text-danger">UGX <span class="count-up" data-value="<?= (float)$monthlyExpense ?>">0</span></h3>
            </div>
                        ...
                        <?php foreach($activeBudgets as $b): ?>
                            ...
                            <div>
                                <div class="d-flex justify-content-between align-items-center mb-1">
                                    ...
                                    <span class="small <?= $textColor ?> fw-bold"><?= $b['percent'] ?>% (UGX <?= number_format($b['spent_amount'], 2) ?>)</span>
                                </div>
                            ...
                            <div class="list-group-item list-group-item-action d-flex align-items-center p-3 border-0 border-start border-4 <?= $borderClass ?> bg-body mb-1 rounded ms-2 me-2 shadow-sm">
                                ...
                                <div class="ms-2 text-end">
                                    <span class="fw-bold <?= $textClass ?>">
                                        <?= $amountPrefix ?>UGX <?= number_format($t['amount']) ?>
                                    </span>
                                </div>
    ...
    new Chart(ctx, {
        ...
        options: {
            ...
            plugins: {
                legend: {
                    position: 'top',
                    labels: { color: textColor, font: { family: "'Segoe UI', Roboto, sans-serif" } }
                },
                tooltip: {
                    callbacks: {
